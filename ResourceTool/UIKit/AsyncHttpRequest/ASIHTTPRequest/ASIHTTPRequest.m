...
+ (void)registerForNetworkReachabilityNotifications
{
	[[Reachability1 reachabilityForInternetConnection] startNotifier];
...
{
	return ([[Reachability1 reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);	
}
